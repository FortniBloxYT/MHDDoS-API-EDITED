...
def downloadsocks(choice):
    ...
    if choice == "4":
        f = open(out_file, 'wb')
        try:
            r = requests.get("https://raw.githubusercontent.com/FortniBloxYT/https-proxy/main/socks4v2.txt",
                             timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/FortniBloxYT/https-proxy/main/socks4v2.txt", timeout=7)
            f.write(r.content)
        except:
            pass
        try:
    ...
    if choice == "5":
        f = open(out_file, 'wb')
        try:
            r = requests.get("https://raw.githubusercontent.com/FortniBloxYT/https-proxy/main/socks5v3.txt",
                             timeout=7)
            f.write(r.content)
        except:
            pass
    ...
    if choice == "1":
        ...
        try:
            ...
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/FortniBloxYT/https-proxy/main/httpss.txt", timeout=5)
            f.write(r.content)
            f.close()
        except:
            pass
...
def usge():
    usgeaseets()
    print('* Coded By MH_ProDev For Better Stresser,API Edited By FortniBloxYT')
